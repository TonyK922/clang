...
![1673268401442](intro.assets/1673268401442.png)

几个源文件, 经过编译生成`.o`目标文件, 这几个目标文件再经过链接器, 与库文件等链接在一起. 最终形成一个可执行的文件:

![1673268497396](intro.assets/1673268497396.png)
...
![1673420783208](intro.assets/1673420783208.png)
...
![1673255243328](intro.assets/1673255243328.png)

![1673266410402](intro.assets/1673266410402.png)
